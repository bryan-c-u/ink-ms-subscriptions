...
public class SecurityConfig {
    ...
    /**
     * {@link JwtAuthenticationFilter} es un {@code @Component} que extiende OncePerRequestFilter, por lo
     * que Spring Boot lo registraria automaticamente como filtro de servlet global (mapeado a "/*")
     * ADEMAS de ejecutarse dentro de la cadena de Spring Security via addFilterBefore(...). Eso hacia
     * que se ejecutara dos veces por request (dos llamadas HTTP a auth-ms). Esta registration
     * deshabilita la version global; el filtro sigue activo dentro de la cadena de seguridad.
     */
    @Bean
